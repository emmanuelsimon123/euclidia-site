...
User visual revision: restored the original play-sky-climb.webp artwork in the large showcase and its enlargement link, with accurate artwork labeling and original 16:9 framing at desktop and phone widths. Removed the gameplay-specific crop. Inspected the source artwork; page verification (15 pages, 152 references) and git diff checks pass. Production visual review follows deployment.

Final publication verified: workflow https://github.com/emmanuelsimon123/euclidia-site/actions/runs/34063994803 passed build, page/link validation, interactive checks, and deployment. Inspected live desktop quiz showcase and restored Sky Climb artwork, plus the actual 390px phone showcase and enlargement dialog. Original artwork retains full 16:9 framing. Versioned homepage stylesheet prevents the prior cached gameplay crop from persisting.
